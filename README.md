...
This repository contains the source code for the [noodle](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.noodle.abyang).

Please see the [issues](https://github.com.noodle.abyang/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about noodle? Ask away on the [com-noodle-abyang discussion forum](https://groups.google.com/forum/#!forum/com-noodle-abyang). 

<a href="https://play.google.com/store/apps/details?id=com.noodle.abyang" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.noodle.abyang__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.noodle.abyang__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.noodle.abyang.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall noodle from your device and
you will then be able to install your own built version.

## Acknowledgements

noodle is a result of a template project I've developed over the years as well as
...
noodle is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.com.noodle.abyang/pulls).
